...
#define MyAppName "Oasis X2 Driver"
...
AppId={{0A495561-E887-4010-BC6E-27EFCE172FAE}
AppName={#MyAppName}
...
OutputBaseFilename=Oasis_X2_Installer
...
Source: "focuserlist Oasis.txt";                      DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion
Source: "focuserlist Oasis.txt";                      DestDir: "{app}\Miscellaneous Files"; DestName: "focuserlist64 Oasis.txt"; Flags: ignoreversion
; 32 bits
Source: "libOasis\Win32\Release\libOasis.dll";          DestDir: "{app}\Plugins\FocuserPlugins"; Flags: ignoreversion
Source: "Oasis.ui";                                   DestDir: "{app}\Plugins\FocuserPlugins"; Flags: ignoreversion
Source: "OasisFocuserSelect.ui";                                   DestDir: "{app}\Plugins\FocuserPlugins"; Flags: ignoreversion
; 64 bits
Source: "libOasis\x64\Release\libOasis.dll";            DestDir: "{app}\Plugins64\FocuserPlugins"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\FocuserPlugins'))
Source: "Oasis.ui";                                   DestDir: "{app}\Plugins64\FocuserPlugins"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\FocuserPlugins'))
Source: "OasisFocuserSelect.ui";                                   DestDir: "{app}\Plugins64\FocuserPlugins"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\FocuserPlugins'))
